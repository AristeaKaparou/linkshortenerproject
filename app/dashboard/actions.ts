...
import { createLinkInDB, isShortCodeAvailable, updateLinkInDB, deleteLinkFromDB } from "@/data/links";
...
export async function updateLink(data: UpdateLinkData): Promise<ActionResult> {
  ...
  if (!updated) {
    return { success: false, error: "Link not found or you do not have permission to edit it" };
  }
